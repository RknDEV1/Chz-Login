...
// O constructor permanece para compatibilidade com o CI e consumidores antigos,
// mas não apresenta UIKit automaticamente.
__attribute__((constructor))
static void CHZLoginBootstrapConstructor(void) {
    NSLog(@"[CHZLogin] bootstrap carregado; apresentação delegada ao app");
}
